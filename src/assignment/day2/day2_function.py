...
def add_to_dict(dictionary, word=None, definition=None):
    if type(dictionary) is not dict:
        return print(f"You need to send a dictionary. You sent: {type(dictionary)}")

    if word == None or definition == None:
...
def get_from_dict(dictionary, word=None):
    if type(dictionary) is not dict:
        return print(f"You need to send a dictionary. You sent: {type(dictionary)}")
    ...
    for key, value in dictionary.items():
        if key is word:
            return print(f"{word}: {value}")

    return print(f"{word} was not found in this dict.")


def update_word(dictionary, word=None, definition=None):
    if type(dictionary) is not dict:
        return print(f"You need to send a dictionary. You sent: {type(dictionary)}")
    ...
    for key in dictionary:
        if key is word:
            dictionary[word] = definition
            return print(f"{word} has been updated to: {definition}")

    return print(f"{word} is not on the dict. Can't update non-existing word.")


def delete_from_dict(dictionary, word=None):
    if type(dictionary) is not dict:
        return print(f"You need to send a dictionary. You sent: {type(dictionary)}")
